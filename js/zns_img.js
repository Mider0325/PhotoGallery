window.onload = function()
{
	...
	for(var i=0; i<aDiv.length;i++)
	{
		...
		aDiv[i].onclick = function()
		{
			...
			startMove(this,{left:0,bottom:50,width:document.documentElement.clientWidth});
		...
		oBlack.onclick = function()
		{
			...
			{
				startMove(aDiv[k],{bottom:200,width:200,left:oldLeft[k]});
